(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("<header>\r\n    <a routerLink=\"\">Corporate UI</a>\r\n</header>\r\n\r\n<section item-toggler *ngFor=\"let item of items; index as i\" text=\"{{item.content.title}}\" [collapsed]=\"false\">\r\n    <a *ngFor=\"let sub of item.items; index as i\" [routerLink]=\"item.url + '/' + sub.url\" routerLinkActive=\"active\" [routerLinkActiveOptions]=\"{exact: true}\">{{sub.content.title}}</a>\r\n</section>");
            /***/ 
        }),
        ...
        /***/ (function (module) {
            module.exports = JSON.parse("{\"name\":\"corporate-ui-site\",\"version\":\"0.0.0\",\"scripts\":{\"ng\":\"ng\",\"start\":\"npm run angular\",\"build\":\"ng build --base-href %npm_package_name%\",\"angular\":\"ng serve --configuration es5 --disable-host-check --port 1337\",\"jekyll\":\"npm run build && cd dist && jekyll serve --baseurl /%npm_package_name% --port 1337\",\"deploy\":\"npm run build && gh-pages -d dist\",\"test\":\"ng test\",\"lint\":\"ng lint\",\"e2e\":\"ng e2e\"},\"private\":true,\"dependencies\":{\"@angular/animations\":\"~8.2.9\",\"@angular/common\":\"~8.2.9\",\"@angular/compiler\":\"~8.2.9\",\"@angular/core\":\"~8.2.9\",\"@angular/forms\":\"~8.2.9\",\"@angular/platform-browser\":\"~8.2.9\",\"@angular/platform-browser-dynamic\":\"~8.2.9\",\"@angular/router\":\"~8.2.9\",\"rxjs\":\"~6.4.0\",\"tslib\":\"^1.10.0\",\"zone.js\":\"~0.9.1\"},\"devDependencies\":{\"@angular-devkit/build-angular\":\"~0.803.9\",\"@angular/cli\":\"~8.3.9\",\"@angular/compiler-cli\":\"~8.2.9\",\"@angular/language-service\":\"~8.2.9\",\"@types/jasmine\":\"~3.3.8\",\"@types/jasminewd2\":\"~2.0.3\",\"@types/node\":\"~8.9.4\",\"codelyzer\":\"^5.0.0\",\"corporate-ui-dev\":\"^4.0.0-gamma.2\",\"gh-pages\":\"2.1.1\",\"jasmine-core\":\"~3.4.0\",\"jasmine-spec-reporter\":\"~4.2.1\",\"karma\":\"~4.1.0\",\"karma-chrome-launcher\":\"~2.2.0\",\"karma-coverage-istanbul-reporter\":\"~2.0.1\",\"karma-jasmine\":\"~2.0.1\",\"karma-jasmine-html-reporter\":\"^1.4.0\",\"marked\":\"^0.7.0\",\"protractor\":\"~5.4.0\",\"scania-theme\":\"^1.0.0-alpha.22\",\"ts-node\":\"~7.0.0\",\"tslint\":\"~5.15.0\",\"typescript\":\"~3.5.3\"}}");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppRoutingModule = /** @class */ (function () {
                function AppRoutingModule(router, ps) {
                    ...
                    this.ps.routes.subscribe(function (items) {
                        // console.log(1, items);
                        _this.router.resetConfig(items.concat([
                ...
                AppRoutingModule.prototype.contentToRoute = function (items) {
                    ...
                    return items.reduce(function (accumulator, item, index) {
                        ...
                        if (item.items)
                            route.children = _this.contentToRoute(item.items);
                        var routes = [route];
                        if (!index)
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("/* autoprefixer grid: autoplace */\n:host {\n  display: -ms-grid;\n  display: grid;\n      grid-template-areas: \"note note\" \"nav main\";\n  -ms-grid-rows: auto 1fr;\n  grid-template-rows: auto 1fr;\n  -ms-grid-columns: 250px 1fr;\n  grid-template-columns: 250px 1fr;\n  overflow: hidden;\n}\n:host ::ng-deep nav a {\n  color: #fff;\n}\n:host ::ng-deep nav a:hover {\n  background-color: transparent;\n  color: #bfbfbf;\n}\nnav {\n  -ms-grid-row: 2;\n  -ms-grid-column: 1;\n  grid-area: nav;\n  background-color: #494949;\n  color: #bfbfbf;\n  --link-color: #fff;\n  --link-color-hover: #bfbfbf;\n  --link-color-active: #fff;\n  overflow-y: auto;\n}\na {\n  color: #fff;\n}\nmain {\n  -ms-grid-row: 2;\n  -ms-grid-column: 2;\n  grid-area: main;\n  overflow-y: auto;\n}\nnote-component {\n  -ms-grid-row: 1;\n  -ms-grid-column: 1;\n  -ms-grid-column-span: 2;\n  grid-area: note;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module) {
            module.exports = JSON.parse("[{\"id\":1,\"title\":\"Component page\",\"sections\":[{\"id\":1,\"title\":\"Description\",\"content\":\"<section [innerHTML]='item.content.description | markdown | keepHtml' class='container'></section>\"},{\"id\":2,\"title\":\"Examples\",\"content\":\"<section class='container' *ngFor='let example of item.content.examples; index as i'><strong>{{example.title}}</strong><p *ngIf='example.description'>{{example.description}}</p><figure [innerHTML]='example.text | keepHtml'></figure><div item-toggler text='Toggle code example'><c-code-sample [innerHTML]='example.text | keepHtml'></c-code-sample></div></section>\"},{\"id\":3,\"title\":\"Technical documentation\",\"content\":\"<section class='container'><strong>Technical documentation</strong><table class='table'><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Value</th></tr></thead><tbody><tr *ngFor='let info of item.content.info; index as i'><td>{{info.name}}</td><td>{{info.docs}}</td><td>{{info.type}}</td><td>{{info.default}}</td></tr></tbody></table></section>\"}]},{\"id\":2,\"title\":\"Overview page\",\"sections\":[{\"id\":1,\"title\":\"Description\",\"content\":\"<section [innerHTML]='item.content.description | markdown | keepHtml' class='container'></section>\"},{\"id\":4,\"title\":\"Preview\",\"content\":\"<section class='container'><div class='row'><ng-container *ngFor='let child of item.parent.items; index as i'><div *ngIf='child.content.examples' [class]='\\\"col-sm-3 \\\" + child.url'><a class='card' [routerLink]='child.url'><div class='card-body' [innerHTML]='child.content.examples[0].text | keepHtml'></div><div class='card-footer'>{{child.content.title}}</div></a></div></ng-container></div></section>\"}]},{\"id\":3,\"title\":\"Markdown\",\"sections\":[{\"id\":1,\"title\":\"Description\",\"content\":\"<section [innerHTML]='item.content.description | markdown | keepHtml' class='container'></section>\"}]},{\"id\":4,\"title\":\"Bootstrap Components\",\"sections\":[{\"id\":1,\"title\":\"Description\",\"content\":\"<section *ngIf='item.content.description' [innerHTML]='item.content.description | markdown | keepHtml' class='container'></section>\"},{\"id\":2,\"title\":\"Examples\",\"content\":\"<section class='container' *ngFor='let example of item.content.examples; index as i'><strong>{{example.title}}</strong><p *ngIf='example.description'>{{example.description}}</p><figure [innerHTML]='example.text | keepHtml'></figure><div item-toggler text='Toggle code example'><c-code-sample [innerHTML]='example.text | keepHtml'></c-code-sample></div></section>\"}]},{\"id\":5,\"title\":\"Color list\",\"sections\":[{\"id\":1,\"title\":\"Colors\",\"content\":\"<section class='container' *ngFor='let example of item.content.examples; index as i'><h4>{{example.title}}</h4><p *ngIf='example.description'>{{example.description}}</p><div color-list [type]='example.type' class='row' classes='col-sm-6 col-md-4 col-lg-2 mb-5'></div></section>\"}]},{\"id\":6,\"title\":\"Icon list\",\"sections\":[{\"id\":1,\"title\":\"Examples\",\"content\":\"<section class='container' *ngFor='let example of item.content.examples; index as i'><strong>{{example.title}}</strong><p *ngIf='example.description'>{{example.description}}</p><pre>{{example.text}}</pre><h5 class='mb-5 mt-5'>Icon List</h5><div icon-list class='row'></div></section>\"}]},{\"id\":7,\"title\":\"\",\"sections\":[{\"id\":1,\"title\":\"Description\",\"content\":\"<section [innerHTML]='item.content.description | markdown | keepHtml' class='container'></section>\"},{\"id\":2,\"title\":\"Examples\",\"content\":\"<section class='container' *ngFor='let example of item.content.examples; index as i'><strong>{{example.title}}</strong><p *ngIf='example.description'>{{example.description}}</p><c-code-sample [innerHTML]='example.text | keepHtml'></c-code-sample></section>\"},{\"id\":3,\"title\":\"Technical documentation\",\"content\":\"<section class='container'><strong>Technical documentation</strong><table class='table'><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Value</th></tr></thead><tbody><tr *ngFor='let info of item.content.info; index as i'><td>{{info.name}}</td><td>{{info.docs}}</td><td>{{info.type}}</td><td>{{info.default}}</td></tr></tbody></table></section>\"}]}]");
            /***/ 
        }),
